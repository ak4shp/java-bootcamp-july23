...
public class Pokerito {
    public static void main(String[] args) {
        ...
        System.out.println("It's like Poker, but a lot simpler.\n\n"
                        ...
                        +" - Then, the dealer will draw ten cards (the river)\n"
        ...
        */
        ...
        /** Task 4 - Draw ten cards
         * 
         * • print:  Now, the dealer will draw ten cards. Press enter to continue.
         ...
         *      ...
         */
        System.out.println("Now, the dealer will draw ten cards. Press enter to continue.");
        scan.nextLine();
        ...
        for(int i=1; i<11; i++){
            ...
            if(dealerCard.equals(userCard)){
                yourMatches++;
            } else if(dealerCard.equals(compCard)){
                computerMatches++;
            }
        }
    ...
    public static String randomCard(){
        String card = "";
        int cardNum = getRandomNumber(1, 14);
